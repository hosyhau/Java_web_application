        ...
        <div id="wrapper">
            ...
            <jsp:include page="nav.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Add  Payment Type</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Information Payment Type
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                <f:form role="form" action="insertPaymentType.htm" method="GET" modelAttribute="newPaymentType" >
                                    <div class="form-group">
                                        <label>PaymentType ID</label>
                                        <f:input path="paymentTypeId"  class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>PaymentType Name</label>
                                        <f:input path="paymentName" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>display Number</label>
                                        <f:input path="displayNumber" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
