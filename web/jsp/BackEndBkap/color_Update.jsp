        ...
        <div id="wrapper">
            ...
            <jsp:include page="nav.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Update Color</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <f:form role="form" action="updateColor.htm" method="GET" commandName="updateColor" >
                                    <div class="form-group">
                                        <label>Color ID</label>
                                        <f:input path="colorId" readonly="true" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
