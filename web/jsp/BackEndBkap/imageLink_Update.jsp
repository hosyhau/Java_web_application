<%-- 
    Document   : imageLink_Update
    Created on : Jun 2, 2017, 7:22:48 PM
    Author     : admin
--%>
        ...
        <div id="wrapper">
            ...
            <jsp:include page="nav.jsp"></jsp:include>
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Update ImageLink</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                        <f:form role="form" action="updateImageLink.htm" method="POST" modelAttribute="updateImageLink" enctype="multipart/form-data" >
                                            <div class="form-group">
                                                <label>ImageLink ID</label>
                                                <f:input path="imageId" readonly="true" class="form-control" require="1"/>
                                            </div>
                                             <div class="form-group">
                                                <label>URL</label>
                                                <f:input  type="file" path="URL" class="form-control" require="1" />
                                            </div>
                                            <div class="form-group">
                                                <label>description</label>
                                                <f:input path="description" class="form-control" require="1" />
                                            </div>
                                            <div class="form-group">
                                                <label>status</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <f:input path="productId" class="form-control" require="1" />
                                            </div>
