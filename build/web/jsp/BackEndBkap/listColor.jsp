<%-- 
    Document   : listColor
    Created on : May 6, 2017, 6:35:09 PM
    Author     : admin
--%>
    ...
    <head>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <main class="main-content">
                        ...
                        <div class="col s12">
                            <div class="card">                       
                                <div class="card-content">
                                    <span class="card-title">Color Table</span> 
                                    <table id="datatable" class="bordered dt-responsive nowrap">
                                        ...
                                        <c:forEach var="color" items="${listColor}">
                                            <tr>
                                                ...
                                                <td>${color.status}</td>
                                                <td><a href="<%= request.getContextPath()%>/color/initUpdateColor.htm?colorID=${color.colorId}">Update</a></td>
                                                <td><a href="<%= request.getContextPath()%>/color/deleteColor.htm?colorID=${color.colorId} onclick="return confirm('Are you Sure?')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                ...
                <a href="initInsertColor.htm" class="col-md-6 btn btn-primary btn-block insert">New Color</a>
        </main>
