                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                        <f:form role="form" action="insertCatalog.htm" method="GET" modelAttribute="newCatalog" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>Category Id</label>
                                                <f:input path="categoryId" class="form-control" required="1" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <f:textarea path="description" class="form-control" required="1" rows="4"></f:textarea>
                                                </div>
                                            <div class="form-group">
                                                <label>Status</label>
                                                ...
                                                <f:input path="parentId"  class="form-control" required="1" />
                                            </div>
