        ...
        <div id="wrapper">
            ...
            <jsp:include page="nav.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Update PaymentType</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Information PaymentType
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                <f:form role="form" action="updatePaymentType.htm" method="GET" modelAttribute="updatePaymentType" >
                                    <div class="form-group">
                                        <label>PaymentType ID</label>
                                        <f:input path="paymentTypeId" readonly="true" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
