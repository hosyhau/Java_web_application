...
<html lang="en">
    ...
    <head>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="/BackEndBkap/jsp/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Website Oto</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Sửa Group</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <f:form role="form" action="updateGroup.htm" method="GET" commandName="updateGroup" >
                                    <div class="form-group">
                                        <label> Group ID</label>
                                        <f:input path="groupId" readonly="true" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label>group Name</label>
                                        <f:input path="groupName" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>status</label>
                            ...
                            <a href="initInsertCatalog.htm">Add New Catalog</a>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
