<%-- 
    Document   : orderDetail_update
    Created on : Jun 3, 2017, 12:31:25 AM
    Author     : admin
--%>
                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                        <f:form role="form" action="updateOrderDetail.htm" method="GET" modelAttribute="updateOrderDetail" >
                                            ...
                                            <div class="form-group">
                                                <label>Amount </label>
                                                <f:input path="amount" class="form-control" required="1" />
                                            </div>
                                            <div class="form-group">
                                                <label>Quantity</label>
                                                <f:input path="quantity"  class="form-control" required="1" />
                                            </div>
                                            <div class="form-group">
                                                <label>Status </label>
