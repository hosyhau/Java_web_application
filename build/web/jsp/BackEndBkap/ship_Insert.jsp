                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                               ...
                               <f:form role="form" action="insertShip.htm" method="GET" commandName="newShip" >
                                    <div class="form-group">
                                        <label>Ship ID</label>
                                        <f:input path="shipId"  class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Distance</label>
                                        <f:input path="distance" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Price Order</label>
                                        <f:input path="priceOder" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Price Of Ship</label>
                                        <f:input path="priceOfShip" class="form-control" required="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                    ...
                                    <button type="submit" class="btn btn-default">New Ship</button>
