<%-- 
    Document   : listOrder
    Created on : May 6, 2017, 6:33:41 PM
    Author     : admin
--%>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <main class="main-content">
                <div class="page-content">
                                    ...
                                    <table id="datatable" class="bordered dt-responsive nowrap">
                                        ...
                                        <c:forEach var="order" items="${listOrder}">
                                            <tr>
                                                ...
                                                <td>${order.userId}</td>
                                                <td>${order.shipId}</td>
                                                <td><a href="initUpdateOrder.htm?orderId=${order.orderId}">Update</a></td>
                                                <td><a href="deleteOrder.htm?orderId=${order.orderId}">Approal</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                 ...
                 <a href="initInsertOrder.htm" class="col-md-6 btn btn-primary btn-block insert">New Order</a>
        </main>
