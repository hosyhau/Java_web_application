<%-- 
    Document   : UserLogin
    Created on : May 29, 2017, 10:34:08 AM
    Author     : admin
--%>
...
<html>
    ...
    <body>
        <jsp:include page="headerUserLogin.jsp"></jsp:include>
                        ...
                        <c:forEach var="pro" items="${listTopSeller}">
                            <div class="col-md-3 product-left">
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="initSingle.htm?productID=${pro.productId}" class="mask"><img class="img-responsive zoom-img" src="${pro.image}" alt="" /></a>
